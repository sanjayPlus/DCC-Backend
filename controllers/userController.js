  ...
  try {
    ...
    sendMail(
      ...
      <div style="margin:50px auto;width:70%;padding:20px 0">
        ...
        <p>Thank you for choosing DCC APP. Use the following OTP to complete your Sign Up procedures. OTP is valid for 20 minutes</p>
        <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">${otp}</h2>
        <p style="font-size:0.9em;">Regards,<br />DCC APP</p>
  ...
  try {
    ...
    await sendMail(
      ...
      <div style="margin:50px auto;width:70%;padding:20px 0">
        ...
        <p style="font-size:1.1em">Hi ${user.name},</p>
        <p>WELCOME TO DCC APP. Thank you for choosing DCC APP.</p>
